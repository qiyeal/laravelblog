...
<div class="wrapper">
    <div class="breadcrumbs" id="breadcrumbs">
        <ol class="breadcrumb">
            <li><a href=""><i class="fa fa-home"></i>首页>>添加文本回复</a></li>
        </ol>
    </div>
    ...
    <div class="row">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="{{url('admin/add_text')}}" method="post">
                    {{csrf_field()}}
                    <table class="table table-bordered">
                        ...
                        <tr>
                            <div class="row">
                                ...
                                <td colspan="3">
                                    <input type="text" name="keyword" value="" placeholder="请输入回复内容">
                                </td>
                            </div>
                        </tr>
                        <tr>
                            <div class="row">
                                ...
                                <td colspan="3">
                                    <textarea name="text" placeholder="请输入回复内容" rows="3" class="form-control"></textarea>
                                </td>
                            </div>
                        </tr>
                        <tr>
