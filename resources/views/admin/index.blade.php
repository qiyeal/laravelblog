...
@section('content')
	...
	<div class="menu_box">
		<ul>
			...
			<li>
				...
				<ul class="sub_menu">
					<li><a href="{{url('admin/weichat')}}" target="main"><i class="fa fa-fw fa-list-ul"></i>消息列表</a></li>
					<li><a href="{{url('admin/article/create')}}" target="main"><i class="fa fa-fw fa-plus-square"></i>添加文章</a></li>
					<li><a href="{{url('admin/article')}}" target="main"><i class="fa fa-fw fa-list-ul"></i>文章列表</a></li>
				</ul>
			</li>
			...
			<li>
				...
				<ul class="sub_menu">
					...
					<li><a href="{{URL::asset('admin/element.html')}}" target="main"><i class="fa fa-fw fa-tags"></i>其他组件</a></li>
				</ul>
			</li>
		</ul>
	</div>
	...
	<div class="bottom_box">
		CopyRight © 2017. Powered By <a href="http://www.jrhuei.com">http://www.jrhuei.com</a>.
	</div>
	<!--底部 结束-->
@endsection
