        ...
        <form action="{{url('admin/config')}}" method="post">
            ...
            <table class="add_tab">
                ...
                <tr>
                    <th>类型：</th>
                    <td>
                        <label><input type="radio" name="field_type" value="input" checked
                                      onclick="showTr()">input</label>
                        <label><input type="radio" name="field_type" value="textarea"
                                      onclick="showTr()">textarea</label>
                        <label><input type="radio" name="field_type" value="radio" onclick="showTr()">radio</label>
                    </td>
                </tr>
